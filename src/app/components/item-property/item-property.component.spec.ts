...
describe('ItemPropertyComponent', () => {
  ...
  it('should render the checkbox and label correctly', () => {
    const mockProperty: Property = { sizeId: 1, sizeName: 'Size 1', price: 100, isChecked: true };
    component.itemId = 1;
    component.property = mockProperty;
    fixture.detectChanges();

    const checkbox = fixture.debugElement.query(By.css('.property__checkbox')).nativeElement;
    const label = fixture.debugElement.query(By.css('.property__label')).nativeElement;
  ...
  it('should dispatch updatePrice action when checkbox is toggled', () => {
    const mockProperty: Property = { sizeId: 1, sizeName: 'Size 1', price: 100, isChecked: false };
    component.itemId = 1;
    component.property = mockProperty;
    fixture.detectChanges();
    ...
    expect(store.dispatch).toHaveBeenCalledWith(updatePrice({
  ...
  it('should dispatch updatePrice action when price is changed', () => {
    ...
    const currencyInput = fixture.debugElement.query(By.directive(CurrencyInputComponent)).componentInstance;
